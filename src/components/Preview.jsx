    ...
    <section id="imageType" className={`imageType__wrap ${props.element}`}>
      <div className="image__inner container">
        <div>
          ...
          <p className="image__desc">
            <PrePostList posts={props.posts.filter(post => post.category === "talk")} />
          </p>
        ...
        <div>
          ...
          <p className="image__desc">
            <PrePostList posts={props.posts.filter(post => post.category === "together")} />
          </p>
      ...
      <div className="image__inner container">
        <div>
          ...
          <p className="image__desc">
            <PrePostList posts={props.posts.filter(post => post.category === "review")} />
          </p>
        ...
        <div>
          ...
          <p className="image__desc">
            <PrePostList posts={props.posts.filter(post => post.category === "promotion")} />
          </p>
